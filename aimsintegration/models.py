...
class TableauData(models.Model):
    ...
    departure_station = models.CharField(max_length=10, null=False, blank=False)
    flight_no = models.CharField(max_length=6, null=False, blank=False)
    flight_leg_code = models.CharField(max_length=10, null=False, blank=False)
    cancelled_deleted = models.BooleanField(default=0)
    arrival_station = models.CharField(max_length=10, null=False, blank=False)
    aircraft_reg_id = models.CharField(max_length=10, null=True, blank=True)
    aircraft_type_index = models.CharField(max_length=10, null=True, blank=True)
    aircraft_category = models.CharField(max_length=10, null=True, blank=True)
    flight_service_type = models.CharField(max_length=10, null=True, blank=True)
    ...
    delay_code_kind = models.CharField(max_length=10, null=True, blank=True)
    delay_number = models.IntegerField(null=True, blank=True)
    aircraft_config = models.CharField(max_length=10, null=True, blank=True)
    seat_type_config = models.CharField(max_length=10, null=True, blank=True)
