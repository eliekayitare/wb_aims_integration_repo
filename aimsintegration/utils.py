...
#                 # If the record exists, check if it has ACARS data
#                 if flight_data:
#                     if any([flight_data.atd_utc, flight_data.takeoff_utc, flight_data.touchdown_utc, flight_data.ata_utc]):
#                         # Skip update if ACARS data is present
#                         logger.info(f"Skipping update for flight {flight_no} on {sd_date_utc} because it has ACARS data.")
#                         continue
#                     else:
#                         # Update existing record without ACARS data
#                         flight_data.tail_no = tail_no
#                         flight_data.dep_code_iata = dep_code_iata
#                         flight_data.dep_code_icao = dep_code_icao
#                         flight_data.arr_code_iata = arr_code_iata
#                         flight_data.arr_code_icao = arr_code_icao
